...
export default function ImagesDashboard() {
    ...
    const fetchTableData = () => {
        ...
        requester.get("media-center/images/get")
            .then((response) => {
                setDataStatus(null);
                setRecords(response.data.model?.filter(design => ((design.imageTarget == "MediaCenter") && (design.imageType == "Design"))));
            }).catch(() => {
                setRecords([]);
    ...
    return (
        <div className='whoWeAreBody'>
            ...
            <div className='section-title'>الصور</div>
