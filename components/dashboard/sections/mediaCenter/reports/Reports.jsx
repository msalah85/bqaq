    ...
    return (
        <div className='ourProjectsBody'>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div className='section-title'>تقارير و انجازات</div>
            ...
            {
                caseToShow == 'add' ? <AddPost fetchTableData={fetchTableData} setCaseToShow={setCaseToShow} postType={3} />
                    :
                    caseToShow == 'update' ? <UpdatePost fetchTableData={fetchTableData} setCaseToShow={setCaseToShow} selectedPost={selectedPost} postType={3} />
                        :
