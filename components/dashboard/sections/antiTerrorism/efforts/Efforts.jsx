...
export default function EffortsDashboard() {
    ...
    const fetchTableData = () => {
        runLoadPanel();
        requester.get("/terrorism/efforts/listing").then((response) => {
    ...
    const onRowInserted = (e) => {
        ...
        requester.post('/terrorism/efforts/create-new-article', { ...e.data }).then((res) => {
            Success();
            fetchTableData();
        }).catch(() => {
            Failed();
    ...
    const onRowUpdated = (e) => {
        runLoadPanel();
        requester.put('/terrorism/efforts/update-article', { ...e.data }).then(() => {
            Success();
            fetchTableData();
        }).catch(() => {
            Failed();
    ...
    const onRowRemoved = (e) => {
        runLoadPanel();
        requester.delete(`/terrorism/efforts/delete-article?articleId=${e.data.id}`).then(() => {
            Success();
            fetchTableData();
    ...
    return (
        <div className='whoWeAreBody'>
            <div className='section-title'>جهود الجمعية</div>
