...
export default function AddProject(props) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} style={{ position: 'relative' }}>
            ...
            <DateBox placeholder='اختر ميعاد للمشروع'
                type="date"
            ...
            {projectImages.length > 0 && <div className='inp-title'>معرض الصور</div>}
            ...
            {projectVideos.length > 0 && <div className='inp-title'>معرض الفيديوهات</div>}
            <div className='whoWeAreDetails__left__section__gridCont' style={{ gridTemplateColumns: 'repeat(4, 1fr)' }}>
