...
export default function WomenSectionDashboard() {
    ...
    const fetchTableData = () => {
        runLoadPanel();
        requester.get("/media-center/posts/get").then((response) => {
            setDataStatus(null);
            setRecords(response.data.model?.filter(post => post.isRelatedToWomanSection) || []);
        }).catch(() => {
            setRecords([]);
    ...
    return (
        <div className='ourProjectsBody'>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <div className='section-title'>القسم النسائي</div>
            ...
            {
                caseToShow == 'add' ? <AddPost fetchTableData={fetchTableData} setCaseToShow={setCaseToShow} />
                    :
                    caseToShow == 'update' ? <UpdatePost fetchTableData={fetchTableData} setCaseToShow={setCaseToShow} selectedPost={selectedPost} />
                        :
