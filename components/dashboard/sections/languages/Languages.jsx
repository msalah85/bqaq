...
export default function LanguagesDashboard() {
    ...
    const onRowInserted = (e) => {
        ...
        requester.post('/lessons/languages/create', { ...e.data })
            .then((res) => {
                Success();
                fetchTableData();
            }).catch(() => {
    ...
    const onRowUpdated = (e) => {
        runLoadPanel();
        requester.put('/lessons/languages/update', { ...e.data })
            .then((res) => {
                Success();
                fetchTableData();
            }).catch(() => {
    ...
    const toggleActivation = (id) => {
        runLoadPanel();
        requester.put('/lessons/languages/delete-or-restore?languageId=' + id).then(() => {
            Success();
            fetchTableData();
        }).catch(() => {
            Failed();
