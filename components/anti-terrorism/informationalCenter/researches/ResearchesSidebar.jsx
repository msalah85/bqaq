...
export default function ResearchesSidebar(props) {
    let timeout = null;
    ...
    const searchHandle = (e) => {
        ...
        timeout = setTimeout(function () {
            ...
            if (e.target.value) {
                search(e.target.value, props.researchData, 'title').then((results) => {
                    setIndexer(results || [])
                })
            }
            else {
                //in case search input is null 
                setIndexer(props.researchData || [])
            }
    ...
    return (
        <div className='sidebar'>
            ...
            <div className='sidebar__switchBtn' style={{ marginTop: '2rem' }}>
                ...
                <ActiveLink activeClassName='activeSwitchBtn' href='/anti-terrorism/informational-center/researches'>
